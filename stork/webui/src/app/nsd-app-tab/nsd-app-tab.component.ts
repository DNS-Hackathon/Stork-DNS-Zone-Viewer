...
import { Bind9DaemonView, NSDDaemon } from '../backend'

@Component({
    selector: 'app-nsd-app-tab',
    templateUrl: './nsd-app-tab.component.html',
    styleUrls: ['./nsd-app-tab.component.sass'],
})
export class NsdAppTabComponent implements OnInit, OnDestroy {
