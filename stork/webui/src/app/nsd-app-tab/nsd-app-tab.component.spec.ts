...
import { NsdAppTabComponent } from './nsd-app-tab.component'
...
describe('Bind9AppTabComponent', () => {
    let component: NsdAppTabComponent
    let fixture: ComponentFixture<NsdAppTabComponent>
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(NsdAppTabComponent)
